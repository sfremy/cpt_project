...
The form triggers the create_account function defined in the JavaScript below when the Login button is pressed.
-->
...
<script type="module">
    ...
    // Attach create_account to the window object, allowing access to form action
